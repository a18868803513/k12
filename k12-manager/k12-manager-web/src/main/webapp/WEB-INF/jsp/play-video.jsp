...
<div class="div"><a href="showAllVideo" >回到上一页</a></div>
<div class="playvideo">
    <div class="zy_media">
        <video onclick="a()" id="aa" width="120%" height="500" data-config='{"mediaTitle": "测试视频--视频"}'
               src="my_video/${tb_video.url}#t=" controls>
        </video>
    </div>
